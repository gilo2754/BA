...
\usepackage[left=3cm,right=2cm,top=1.5cm,bottom=1.5cm,
...
\input{chapters/Zahlungsmodelle}
\newpage

\section{Kostenüberwachung}\label{kap_kostenüberwachung }
\input{chapters/Kostenüberwachung}
\newpage

\section{Optimierungsmaßnahmen}\label{kap_Optimierung}
\input{chapters/Optimierung}
\newpage

\section*{Zusammenfassung und Ausblick}\label{kap_zusammfAusbl}
\addcontentsline{toc}{section}{Zusammenfassung und Ausblick} % Manuellen Eintrag im Inhaltsverzeichnis erzeugen
...
\input{chapters/Quellenverzeichnis}
\newpage
