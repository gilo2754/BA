...
\begin{quote}
    ...
    \footnote{\cite{AMZ11} \cite{AMZ11}}
\end{quote}
...
Zusätzlich gibt es bei Saving Plans und reservierten Instanzen die Option im Voraus zu zahlen. Im Gegenzug wird ein niedrigerer Preis angeboten. Amazon bietet drei verschiedene Optionen an. Diese sind teilweise, keine oder vollständige Vorauszahlung\footnote{\cite{AMZ17}}. Bei teilweiser Vorauszahlung ist eine Anzahlung von etwa 50\% zu leisten.
\\\\
...
\begin{figure}[h!]
    ...
    Eigene Darstellung. Quelle: \footnote{\cite{AMZ02, AMZ07, AMZ11, AMZ19}},
    \footnote{\cite{PS1} Seite 9}
  \end{figure}
