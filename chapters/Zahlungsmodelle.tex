...
Hier sind zwei Fälle. In einem Fall ist die reservierte Rechnerkapazität sehr gering und es wird viel On-Demand-Instanzkapazität benötigt. Im zweiten Fall ist die reservierte Instanzkapazität zu hoch und die Verwendung von On-Demand-Instanzen wäre insgesamt rentabler gewesen.
%SHOW THIS
%https://medium.com/driven-by-code/how-truecar-saves-40-on-aws-with-ec2-reserved-instances-d0a6e0d9c08a
[SHOW: How TrueCar Saves 40\% on AWS with EC2 Reserved Instances]
