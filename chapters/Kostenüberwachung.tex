...
\begin{center}
      \includegraphics[scale=0.7]{sources/TH_Koeln_Logo}
      \label{fig:AWS Trusted Advisor Kategorien}\\
      \textbf{Abbildung \autoref{fig:AWS_Trusted_Advisor_Kategorien}:} AWS Trusted Advisor Kategorien
      %\footnote{Vgl. u.a.\cite{AMZ01}}
  \end{center}
  Abbildung X zeigt die 5 Kategorien von Trusted Advisor mit jeweils 3 Arten von Indikatoren. 
  Die Indikatoren zeigen an, welche Kontrollen durchgeführt wurden.
