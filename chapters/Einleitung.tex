...
Zudem wird aufgezeigt, welche Maßnahmen nötig sind, um unerwartet hohe Kosten bei Cloud-Diensten zu vermeiden. In diesem Sinne wird untersucht %,werden Empfehlungen von Cloud-Experten berücksichtigt, 
...
%Die vorliegende Arbeit betrachtet die von AWS angebotenen Überwachungswerkzeuge, mit Hilfe derer ein tiefgehendes Verständnis der Kosten, die durch die Nutzung von Cloud-Diensten entstehen, erlangt werden kann. Mit den zur Verfügung gestellten Maßnahmen sollen die Nutzung und damit die Kosten von Cloud-Diensten reduziert werden.
...
%Indem sie die Nutzung der Cloud-Dienste reduzieren und die passende Art des Dienstes wählen. Das resultiert in mehr Kontrolle über die anfallenden Kosten. 
...
%Diese dienen als Grundlage für diese Arbeit. 
\\\\
