...
Die zunehmende Digitalisierung von Geschäftsmodellen, die auch durch die Corona-Pandemie vorangetrieben wird{\cite{STA3}}, lässt Cloud-basierte Applikationen an Bedeutung gewinnen. Dies wird auch von 48\% der befragten Handelsunternehmen im Jahr 2021 bestätigt{\cite{STA2}}. Als direkte Folge davon steigt die Nachfrage nach Server- und Speicherkapazität. 
...
\\
%Die relevanten Cloudanbieter weltweit sind AWS, Google, Telekom und Microsoft.
...
\begin{flushleft}
In dieser Arbeit wird versucht zu beantworten, wie Kosten bei Cloud-Diensten überwacht werden können. Auf Grundlage dieser Information werden Optimierungsmöglichkeiten gesucht. Es wird untersucht, welche Maßnahmen nötig sind, um unerwartet hohe Kosten bei Cloud-Diensten zu vermeiden.Darüber hinaus werden Empfehlungen von Cloud-Experten berücksichtigt, um Kosten von Cloud-Diensten zu minimieren. 
Diese Arbeit entwickelt sich am Beispiel von S3 Speichereinheiten und EC2-Instanzen. 
\end{flushleft}
