...
Amazon Web Services, kurz AWS, wurden unter anderem als Fallbeispiel für diese Arbeit ausgewählt wegen seiner frühen Präsenz (2006) als Cloudanbieter und seines großen Angebotes an Diensten, welche für zahlreiche Anwendungsfälle geeignet sind.
\\
...
[5x\% von Unternehmen haben Schwierigkeiten ihre Kosten zu begründen und das Mangel an fachliches Know-How in Cloud-Computing ist eine der größte Hindernis für die Wechsel von On-Premise- zu Cloud-basierten Systemen]
\\\\
